...
function generateStateSevenHTML(dimmed = false) {
    ...
    <div class="energy-shop-ui-wrap flex-core flex-col flex-start">
            ...
            <div class="energy-shop-ui-type-ctr flex-core flex-row flex-start">
                ...
                <p id="energy-selector-01-price" class="energy-shop-type-price flex-core flex-row flex-center"><span>$</span>300</p>
                </div>
                ...
                <p id="energy-selector-02-price" class="energy-shop-type-price flex-core flex-row flex-center"><span>$</span>500</p>
                </div>
                ...
                <p id="energy-selector-03-price" class="energy-shop-type-price flex-core flex-row flex-center"><span>$</span>700</p>
                </div>
                ...
                <p id="energy-selector-04-price" class="energy-shop-type-price flex-core flex-row flex-center"><span>$</span>1000</p>
                </div>
