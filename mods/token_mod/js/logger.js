function logStateChange(newState) {
    ...
    switch (newState) {
        ...
        case 3:
            ...
            console.log(`gcgTokens: ${gcgTokens}`);
            console.log("------------------------------------");
            break;
        case 4:
        ...
        case 10:
            ...
            break;
        case 11:
            console.log("[State 11] :: Grind trade UI triggered");
            console.log("------------------------------------");
            break;
        case 12:
            console.log("[State 12] :: Token trade UI triggered");
            console.log("------------------------------------");
            break;
        case 13:
            console.log("[State 13] :: XYZ token trade signature request triggered");
            console.log("------------------------------------");
            break;
        case 14:
            console.log("[State 14] :: GRIND Token trade signature request triggered");
            console.log("------------------------------------");
            break;
        default:
